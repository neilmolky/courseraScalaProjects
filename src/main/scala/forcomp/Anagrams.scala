...
object Anagrams extends AnagramsInterface:
  ...
  def sentenceOccurrences(s: Sentence): Occurrences =
    s
      .foldRight(Nil)(y, ys => wordOccurrences(y) :: ys)
      .groupBy((x: (Char, Int)) => x._1)
  ...
  def combinations(occurrences: Occurrences): List[Occurrences] =
    def addCombination(o: Occurrences): Set[List[Occurrences]] =
      if o.isEmpty then Set(List())
      else
        for
        combo -> addCombination(o.tail)
        item -> combo
